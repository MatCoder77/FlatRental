...
public class LocalityService {
    ...
    public com.flatrental.api.location.LocalityDTO mapToLocalityDTO(Locality locality) {
        return new com.flatrental.api.location.LocalityDTO(locality.getId(), locality.getName(), locality.getLocalityType());
    }
